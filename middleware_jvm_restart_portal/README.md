...
LDAP is handled by Flask, not Apache.
...
Apache proxies /login to Flask
        |
        v
Flask performs LDAP authentication and creates a session cookie
        |
        v
...
# history.sqlite3 is stored directly in the application folder by default
HISTORY_LIMIT=50
...
```text
/opt/middleware-jvm-restart/app/history.sqlite3
```
